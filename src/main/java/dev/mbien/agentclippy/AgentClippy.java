            ...
            clb.withFlags(ClassFile.ACC_PUBLIC)
                ...
                .withMethodBody("handleContentsChanged", MTD_void, ACC_PUBLIC,
                    cob -> {
                        ...
                        DirectMethodHandleDesc bsm = MethodHandleDesc.ofMethod(
                                DirectMethodHandleDesc.Kind.STATIC, ClassDesc.of("java.lang.invoke.LambdaMetafactory"), "metafactory",
                ...
                .withMethodBody("handleContentsChanged0", MTD_void, ACC_PUBLIC, cob -> {
                    ...
                    cob.aconst_null()
                       ...
                       .aload(0)
                       .aconst_null()
                       .invokevirtual(CD_WClipboard, "openClipboard", MethodTypeDesc.of(CD_void, CD_SunToolkit))
                       .aload(0)
